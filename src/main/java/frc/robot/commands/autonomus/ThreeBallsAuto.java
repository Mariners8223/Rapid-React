...
public class ThreeBallsAuto extends SequentialCommandGroup {
  public ThreeBallsAuto() {
    addCommands(new OneBallAuto(), new CollectTwoBallsRight(), new IntakeBalls(Constants.RAISE_PULLIES_ENUM, Constants.NO_TIME), new TransportBalls(false, 0.5), new ShootCycle(2.0), new PathFollower(Constants.ONE_BALL_PATH1));
  }
}
