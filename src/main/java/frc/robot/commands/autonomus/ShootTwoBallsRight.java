...
public class ShootTwoBallsRight extends SequentialCommandGroup {
  public ShootTwoBallsRight() {
    addCommands(new PathFollower(Constants.BALL_BEHIND_RIGHT_HUB_PATH), new TransportBalls(false, 0.5, Constants.TRANSPORT_SPEED), new ShootCycle(3, 0.36), new PathFollower(Constants.ONE_BALL_PATH));
  }
}
